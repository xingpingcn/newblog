...
- [使用 freecdn-js 提高 hexo 博客的 cdn 稳定性](/hexo-blog-tweaks/使用freecdn-js提高hexo博客的cdn稳定性)
...
[进阶设置 / 使用 freecdn-js](/hexo-blog-tweaks/使用freecdn-js提高hexo博客的cdn稳定性)
...
```yaml title="_config.volantis.yml"
cdn:
  enable: true
