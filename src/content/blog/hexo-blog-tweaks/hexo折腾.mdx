---
title: '使用 volantis 中遇到的坑'
description: 'volantis404 页面不生效？sidebar 效果不生效？如何更改图片尺寸？手机模式下 toc 会被遮挡'
date: 2023-04-20
order: 1
tags: ['volantis']
keywords:
...
按照官方的[文档](https://volantis.js.org/v6/page-settings/#404%E9%A1%B5%E9%9D%A2)配置 404 页面，在本地打开一个不存在的页面，并不显示 404 页面，重启服务器依然不行。干脆直接放到 GitHub page 上，结果 404 页面能生效
...
```html title="blog/node_modules/hexo-theme-volantis/layout/_widget/blogger.ejs"
<section
...
```html title="blog/node_modules/hexo-theme-volantis/layout/_widget/xxx.ejs"
...
```styl title="blog/node_modules/hexo-theme-volantis/source/css/_style/_layout/img.styl"
.md
  img
    position: relative
    trans()
...
```styl title="blog/node_modules/hexo-theme-volantis/source/css/_first"
.l_header
  $iconW = 36px
  $iconMargin = 4px
  position: fixed
...
```html title="node_modules/hexo-theme-volantis/layout/_partial/head.ejs"
<!-- 更改之前 -->
