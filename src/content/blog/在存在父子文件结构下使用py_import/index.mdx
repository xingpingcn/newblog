---
title: '在存在父子文件结构情况下使用python import'
description: '在存在父子文件结构情况下使用python import，深刻理解python如何引import用子文件和父文件。Attempted relative import with no known parent package'
date: 2023-04-01
tags: ['python']
keywords:
  ['python引入子文件夹 python引入父文件夹 绝对引入 相对引入 __init__.py']
authors: ['xingpingcn']
---
