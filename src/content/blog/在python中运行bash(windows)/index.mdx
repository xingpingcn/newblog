---
title: '在python中运行bash实时输出结果（windows）'
description: '在windows系统下的python中使用环境变量运行bash'
date: 2023-04-01
tags: ['python']
keywords:
...
`bash_path`用于定位你的git工具的`bash`，参数`cwd=`用于定位你的工作目录，和在文件夹中右键`git bash here`是一样的效果。
