...
const databasePath = path.resolve('data/image-metadata.sqlite')
const generatedPath = path.resolve('src/generated/image-metadata.ts')
const defaultHeaders = {
  'user-agent': 'newblog-image-metadata/1.0',
